...
*****************************************************************
* Outtable - Pivot table program with export excel capability	*
*  		Alex Sax, asax@stanford.edu								*
*  		RTI International, EPS									*
*  																*
* Outtable works in three stages: load, calculate, clean.  It   *
* is written 98% in STATA with a few lines in MATA that will be *
* thoroughly commented.											*
*****************************************************************


program outtable, eclass
version 12
...
* Outtable calculates summary stats for each subgroup by nested *
* loops (3 of em). See below.									*
*****************************************************************
...
foreach subtest in `varlist' {
	*************************************************************
	* Outtable uses postfiles to save statistics, so here we 	*
